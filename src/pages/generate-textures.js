...
function determineType(filename) {
    ...
    if (lower.includes('thumb') || lower.includes('material_') || lower.includes('preview'))
        return 'THUMB';
    if (lower.includes('col') || lower.includes('color') || lower.includes('albedo'))
        return 'COL';
    if (lower.includes('nrm') || lower.includes('normal') || lower.includes('norm'))
        return 'NRM';
    if (lower.includes('hgt') || lower.includes('height') || lower.includes('disp'))
        return 'HGT';
    return null;
}
