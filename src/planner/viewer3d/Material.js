...
export class Material {
    textures;
    unloadedMaterials = new Map();
    loadedMaterials = new Map();
    activeWallMaterial = null;
    activeFloorMaterial = null;
    activeRoofMaterial = null;
    activeWindowFrameMaterial = null;
    activeDoorFrameMaterial = null;
    activeDoorMaterial = null;
    ...
    registerWindowFrameMaterial(id) {
    ...
    // -------------------------------------------------------
    windowMaterial(texture, normalTexture, heightTexture) {
